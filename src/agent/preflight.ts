...
export type LocalAgentId = 'claude' | 'codex' | 'mimo' | 'opencode' | 'hermes';
...
export function isAgentPreflightDiagnostic(input: unknown): input is AgentPreflightDiagnostic {
  ...
  return (
    ...
    (raw.agentId === 'claude' || raw.agentId === 'codex' || raw.agentId === 'mimo' || raw.agentId === 'opencode' || raw.agentId === 'hermes') &&
