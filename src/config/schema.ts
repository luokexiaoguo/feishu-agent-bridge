...
export interface AppPreferences {
  ...
  /**
   * How long a channel disconnect (reconnect / restart / keepalive) waits
   * for in-flight runs to finish before force-stopping them, in ms. Default
   * 90000 (90s). 0 restores the old immediate-kill behavior. Long replies
   * must not be aborted by a WS hiccup, so keep this generous.
   */
  disconnectRunGraceMs?: number;
  /**
